...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the EmaRemote network..."),
        ...
        ("install_tip", "Due to UAC, EmaRemote can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install EmaRemote to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant EmaRemote \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant EmaRemote \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow EmaRemote to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [EmaRemote Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next EmaRemote application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant EmaRemote \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant EmaRemote \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running EmaRemote."),
        ...
        ("verify_rustdesk_password_tip", "Verify EmaRemote password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use EmaRemote and start the service, do not proceed and hang up immediately."),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent EmaRemote from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by EmaRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if EmaRemote window is open"),
        ...
        ("floating_window_tip", "It helps to keep EmaRemote background service"),
        ...
        ("About RustDesk", "About EmaRemote"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, EmaRemote verifies the server certificate for protocols using TLS.\nWith this option enabled, EmaRemote will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, EmaRemote will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: EmaRemote server OSS doesn't include this feature."),
